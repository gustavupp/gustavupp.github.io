function displayBookSearch(data){
    ...
    const result = searchData1.map((item)=>{
        ...
        <a href="#"><img src="${(item.volumeInfo.imageLinks)? item.volumeInfo.imageLinks.thumbnail : "https://dummyimage.com/120x150/000/fff.png&text=No+Cover!"}" alt="image" class="book-cover" style="max-width: 150px;" /></a>
        <div class="book-info">
