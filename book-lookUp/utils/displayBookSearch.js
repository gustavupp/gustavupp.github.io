function displayBookSearch(data){
    ...
    const result = searchData1.map((item)=>{
        return `<div class="card">
                    <img src="${(item.volumeInfo.imageLinks)? item.volumeInfo.imageLinks.thumbnail : "https://dummyimage.com/120x150/000/fff.png&text=No+Cover!"}" alt="image" class="book-cover" data-id="${item.id}" style="max-width: 150px;" />
                    <div class="book-info">
