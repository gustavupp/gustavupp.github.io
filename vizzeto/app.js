...
toggleBtn.addEventListener('click', function () {
  ...
  //this changes the div that wraps the "ul".. we are determining the height of this div container by the size of the "ul"...if it changes then the container height will follow
...
window.addEventListener('scroll', () => {
  if (window.pageYOffset > navCenterHeight)
    navCenter.classList.add('fixed-navbar')
  //we add this class to the navBar to change its features when past certain height
...
scrollLinks.forEach(function (link) {
  //select all links and loop through to listen for a click event.
  link.addEventListener('click', function (e) {
    ...
    const navHeaderHeight = document
...
const articleContainer = document.querySelector(
  '.articles-and-buttons-container'
)
